...
def get_args_parser():
    ...
    parser.add_argument("--local_embedding_path", default="local_codebook_embedding.pth", type=str, help="path of llama model")
    parser.add_argument("--global_embedding_path", default="global_codebook_embedding.pth", type=str, help="path of llama model")
